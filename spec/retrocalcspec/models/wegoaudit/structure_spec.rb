...
describe Wegoaudit::Structure do
  ...
  describe '#location' do
    ...
    it 'is the sample group name if structure has sample_group_id' do
      ...
      audit = Wegoaudit::Audit.new(sample_groups: sample_group_json)

      structure = described_class.new(sample_group_id: 'bar', audit: audit)
      expect(structure.location).to eq 'sample group 2'
    end
