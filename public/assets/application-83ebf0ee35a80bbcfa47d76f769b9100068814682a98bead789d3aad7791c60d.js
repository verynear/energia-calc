...
(function (window, document, $, undefined) {
	...
	D.ready(function() {
	 ...
	 var developerKey = 'AIzaSyBEAQG6IZWT8ckXoecWhEW1WnIi_yxP8T4'
     var clientid = '869737979954-hmbe1t1m351dr5u8tgia4ieudc1711ac.apps.googleusercontent.com'
	...
	$.extend(Collapse.prototype, {
		toggle: function() {
			...
			if (this.options.ease) {
				this.$target[$.camelCase(this.options.ease + '-toggle')](100);
			} else {
...
(function() {
  ...
  window.Modal = (function(superClass) {
    ...
    Modal.prototype.template = _.template("<div class='js-modal modal'>\n</div>");
    ...
    Modal.prototype.afterLoad = function() {};

    Modal.prototype.submitForm = function(event) {};

    Modal.prototype.onClickClose = function() {
      event.preventDefault();
      return this.$el.trigger('closeModal');
    };
...
(function() {
  window.AuditReports = {
    ...
    generate: function(params) {
      return new AuditReports.Generator(params);
    }
  };

  window.triggerAuditReportSummary = function(data) {
    AuditReports.EventBus.trigger("channel:effective_structure_field_values", ['change', data.audit_report_summary.effective_structure_values_lookup]);
    return AuditReports.EventBus.trigger("channel:audit_report_summary:" + data.audit_report_summary.id, ['change', data.audit_report_summary]);
  };

}).call(this);
(function() {
  AuditReports.Generator = (function() {
    function Generator(params) {
      var auditReport, page;
...
(function() {
  ...
  AuditReports.Models.AuditReportNameFieldValue = (function(superClass) {
    extend(AuditReportNameFieldValue, superClass);

    function AuditReportNameFieldValue() {
      return AuditReportNameFieldValue.__super__.constructor.apply(this, arguments);
    }

    AuditReportNameFieldValue.prototype.defaults = {
      id: '',
      name: '',
      value: '',
      from_audit: false
    ...
    return AuditReportNameFieldValue;
...
(function() {
  ...
  AuditReports.Models.AuditReportSummary = (function(superClass) {
    extend(AuditReportSummary, superClass);

    function AuditReportSummary() {
      this._listenToChannel = bind(this._listenToChannel, this);
      return AuditReportSummary.__super__.constructor.apply(this, arguments);
    }

    AuditReportSummary.prototype.relations = [
      {
        type: Backbone.HasMany,
    ...
    AuditReportSummary.prototype.defaults = {
      id: '',
    ...
    AuditReportSummary.prototype.initialize = function() {
      return AuditReports.EventBus.on("channel:audit_report_summary:" + (this.get('id')), this._listenToChannel);
    };

    AuditReportSummary.prototype._listenToChannel = function(args) {
      var data, event;
...
(function() {
  ...
  AuditReports.Models.FieldValue = (function(superClass) {
    extend(FieldValue, superClass);

    function FieldValue() {
      this.get_default_value = bind(this.get_default_value, this);
      return FieldValue.__super__.constructor.apply(this, arguments);
    }

    FieldValue.prototype.defaults = {
      id: '',
      name: '',
      api_name: '',
      value: '',
    ...
    FieldValue.prototype.get_default_value = function() {
      var ref, value;
      value = this.get('default');
      if ((ref = typeof value) === 'number' || ref === 'string') {
        return value;
      }
      if (this.get('structure').get('proposed')) {
...
(function() {
  ...
  AuditReports.Models.MeasureDefinition = (function(superClass) {
    extend(MeasureDefinition, superClass);

    function MeasureDefinition() {
      return MeasureDefinition.__super__.constructor.apply(this, arguments);
    }

    MeasureDefinition.prototype.defaults = {
      api_name: '',
      data: {}
    };
...
(function() {
  ...
  AuditReports.Models.MeasurePhoto = (function(superClass) {
    extend(MeasurePhoto, superClass);

    function MeasurePhoto() {
      return MeasurePhoto.__super__.constructor.apply(this, arguments);
    }

    MeasurePhoto.prototype.defaults = {
      id: '',
      medium_url: '',
      thumb_url: '',
      selected: false
  ...
  AuditReports.Models.MeasurePhoto.setup();
...
(function() {
  ...
  AuditReports.Models.NameFieldValue = (function(superClass) {
    extend(NameFieldValue, superClass);

    function NameFieldValue() {
      return NameFieldValue.__super__.constructor.apply(this, arguments);
    }

    NameFieldValue.prototype.defaults = {
      id: '',
      name: '',
      value: '',
      from_audit: false
...
(function() {
  ...
  AuditReports.Models.OriginalStructureFieldValue = (function(superClass) {
    extend(OriginalStructureFieldValue, superClass);

    function OriginalStructureFieldValue() {
      this._listenForOriginalStructureChange = bind(this._listenForOriginalStructureChange, this);
      this._listenForEffectiveStructureChange = bind(this._listenForEffectiveStructureChange, this);
      return OriginalStructureFieldValue.__super__.constructor.apply(this, arguments);
    }

    OriginalStructureFieldValue.prototype.defaults = {
      id: '',
      real_id: '',
      name: '',
      api_name: '',
    ...
    OriginalStructureFieldValue.prototype.initialize = function() {
      this.listenTo(AuditReports.EventBus, "channel:effective_structure_field_values", this._listenForEffectiveStructureChange);
      return this.listenTo(AuditReports.EventBus, "channel:original_structure_field_value:" + (this.get('real_id')), this._listenForOriginalStructureChange);
    };

    OriginalStructureFieldValue.prototype._listenForEffectiveStructureChange = function(args) {
      var data, effectiveValue, effectiveValues, event;
      event = args[0], data = args[1];
      effectiveValues = data[this.get('measure_selection_id')][this.get('structure_wegoaudit_id')];
      effectiveValue = effectiveValues[this.get('api_name')];
      return this.set('effective_value', effectiveValue);
    };

    OriginalStructureFieldValue.prototype._listenForOriginalStructureChange = function(args) {
      var data, event;
      event = args[0], data = args[1];
      return this.set('value', data);
    };

    return OriginalStructureFieldValue;
...
(function() {
  ...
  AuditReports.Models.QuantityFieldValue = (function(superClass) {
    extend(QuantityFieldValue, superClass);

    function QuantityFieldValue() {
      return QuantityFieldValue.__super__.constructor.apply(this, arguments);
    }

    QuantityFieldValue.prototype.defaults = {
      id: '',
      name: '',
      value: '',
      from_audit: false
...
(function() {
  ...
  AuditReports.Collections.MeasurePhotos = (function(superClass) {
    extend(MeasurePhotos, superClass);

    function MeasurePhotos() {
      return MeasurePhotos.__super__.constructor.apply(this, arguments);
    }

    MeasurePhotos.prototype.model = AuditReports.Models.MeasurePhotos;

    MeasurePhotos.prototype.setSelected = function(photo) {
...
(function() {
  ...
  AuditReports.Views.Field = (function(superClass) {
    extend(Field, superClass);

    function Field() {
      this._onBlurInput = bind(this._onBlurInput, this);
      return Field.__super__.constructor.apply(this, arguments);
    }

    Field.prototype.tagName = 'div';

    Field.prototype.className = 'col-6';

    Field.prototype.inputClass = "js-structure-field";
    ...
    Field.prototype.inputFieldTemplate = _.template("<div class=\"fli js-fli\">\n  <label class=\"fli__label\"><%= name %></label>\n  <input data-api-name='<%= apiName %>'\n         type=\"text\"\n         class=\"fli__input js-fli-input\"\n         required\n         <%= pattern %>\n         value=\"<%= value %>\">\n</div>");

    Field.prototype.selectFieldTemplate = _.template("<div class=\"fli fli--has-select js-fli\">\n  <label class=\"fli__label\"><%= name %></label>\n  <select data-api-name='<%= apiName %>'\n          class='js-fli-input fli__input'\n          required>\n    <option value=\"\">Select an option</option>\n    <%= options %>\n  </select>\n</div>");

    Field.prototype.resetIconHtml = "<a href=\"#\" class=\"fli__reset fli__append js-reset-value\">\n  <i class=\"icon-reset\"></i>\n</a>";

    Field.prototype.render = function() {
      var html;
      html = this.setHtml();
      this.$el.html(html);
      this.$fli = this.$('.js-fli');
      this.$input = this.$('.js-fli-input');
      this.$input.addClass(this.inputClass);
      this._checkValidity();
      this.$input.on('blur', this._onBlurInput);
      if (this.$input.val() !== '') {
        this.$fli.addClass('is-completed');
      } else if (this.model.get('default')) {
        this.$fli.addClass('is-completed');
        this.$fli.removeClass('error');
        this.$input.attr('placeholder', this.model.get_default_value);
      }
      this.setDisabled();
      if (this.model.get('from_audit')) {
        this.$fli.append(this.resetIconHtml);
      }
      return this.$el;
    };
    ...
    Field.prototype.setHtml = function() {
      var options;
      if (this.model.get('value_type') === 'picker') {
        options = _(this.model.get('options')).map((function(_this) {
          return function(option) {
            var selected;
            selected = option === _this.model.get('value') ? 'selected' : '';
            return "<option " + selected + " value='" + option + "'>" + option + "</option>";
          };
        })(this));
        return this.selectFieldTemplate({
    ...
    Field.prototype._onClickResetLink = function(event) {
      event.preventDefault();
      this.$input.val(this.model.get('original_value'));
      return this.syncFieldValue();
    };

    Field.prototype._onBlurInput = function(event) {
      this.$input.removeClass('is-active');
      this._checkValidity();
      if (this.$input.val() === '' && !this.model.get('default')) {
        return this.$fli.removeClass('is-completed');
      }
    };

    Field.prototype._onChangeInputValue = function(event) {
      this.model.set({
    ...
    Field.prototype._onClickFliDiv = function(event) {
      event.preventDefault();
      return this.$input.focus();
    };

    Field.prototype._onFocusInput = function(event) {
      var appendWidth, prependWidth;
      this.$fli.addClass('is-completed');
      this.$input.addClass('is-active');
      prependWidth = this.$input.siblings('.js-fli-prepend').outerWidth();
      appendWidth = this.$input.siblings('.js-fli-append, .js-reset-value').outerWidth();
      this.$input.css({
        'padding-left': prependWidth,
        'padding-right': appendWidth
      });
      return this.$input.siblings('.js-reset-value').fadeIn();
    };

    Field.prototype._checkValidity = function() {
      if (this.model.get('default') && this.$fli.val() === '') {
        return this.$fli.removeClass('error');
      } else if (!this.$input.get(0).checkValidity()) {
        return this.$fli.addClass('error');
      } else {
        return this.$fli.removeClass('error');
      }
    };
    ...
    Field.prototype.syncUrl = function() {
      return ("/calc/structures/" + (this.model.get('structure').get('id'))) + ("/field_values/" + (this.model.get('id')));
    };

    Field.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
        url: this.syncUrl(),
        data: {
        ...
        success: this._afterSyncFieldValue
      });
    };

    Field.prototype._afterSyncFieldValue = function(data) {
      return triggerAuditReportSummary(data);
    };

    Field.prototype._validationPattern = function() {
      var ref;
      if ((ref = this.model.get('value_type')) === 'decimal' || ref === 'integer') {
        return "pattern='\\d+(\\.?\\d+)?'";
      }
    };
...
(function() {
  ...
  AuditReports.Views.NameField = (function(superClass) {
    extend(NameField, superClass);

    function NameField() {
      return NameField.__super__.constructor.apply(this, arguments);
    }

    NameField.prototype.className = 'col-auto';

    NameField.prototype.inputClass = "js-structure-name-field";

    NameField.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
        url: "/calc/structures/" + (this.model.get('id')),
        data: {
          structure: {
            name: this.$input.val()
          }
...
(function() {
  ...
  AuditReports.Views.TotalsBar = (function(superClass) {
    ...
    TotalsBar.prototype.render = function() {
      this.$el.html(this.template(this.model.attributes));
      this.$el.css('transform', 'translateY(69px)');
      return this.$el;
    };

    TotalsBar.prototype.postRender = function() {
      this.$totalsToggle = $('.js-totals-toggle');
      this.$totalsLevel1 = $('.js-totals-level1');
      this.$totalsLevel2 = $('.js-totals-level2');
      this.totalsHeight = this.$el.outerHeight();
      this.totalsLevel1Height = this.$totalsLevel1.outerHeight();
      this.totalsLevel2Height = this.$totalsLevel2.outerHeight();
      $('body').css('padding-bottom', this.totalsHeight + 20);
      this.stateDefault = "translateY(" + this.totalsLevel2Height + ")";
      this.stateExpanded = 'translateY(0)';
      this.stateCollapsed = "translateY(" + (this.totalsLevel2Height + this.totalsLevel1Height - 4) + "px)";
      return this.setCollapsedState();
    };

    TotalsBar.prototype.setCollapsedState = function() {
      var storedState;
      storedState = localStorage.getItem('panelState');
      if (storedState) {
        if (localStorage.getItem('panelState') === 'default') {
          return this.$el.css({
            transform: this.stateDefault
          });
        } else {
          return this.$el.css({
            transform: this.stateCollapsed
    ...
    TotalsBar.prototype.onToggleTotal = function(event) {
      event.preventDefault();
      if (localStorage.getItem('panelState') === 'default') {
        this.$el.css({
          transform: this.stateCollapsed
        }).addClass('is-collapsed');
        return localStorage.setItem('panelState', 'collapsed');
      } else {
        this.$el.css({
          transform: this.stateDefault
        }).removeClass('is-collapsed');
        return localStorage.setItem('panelState', 'default');
      }
    };
...
(function() {
  ...
  AuditReports.Views.AddMeasureModal = (function(superClass) {
    ...
    AddMeasureModal.prototype.submitForm = function(event) {
      event.preventDefault();
      return $.ajax({
...
(function() {
  ...
  AuditReports.Views.AddReportModal = (function(superClass) {
    extend(AddReportModal, superClass);

    function AddReportModal() {
      return AddReportModal.__super__.constructor.apply(this, arguments);
    }

    AddReportModal.prototype.afterLoad = function() {
      return this.$form = this.$('form');
    };

    AddReportModal.prototype.submitForm = function(event) {
      if (!this.$('.js-select-audit-radio-button').is(':checked')) {
...
(function() {
  ...
  AuditReports.Views.AddStructureChangeModal = (function(superClass) {
    extend(AddStructureChangeModal, superClass);

    function AddStructureChangeModal() {
      return AddStructureChangeModal.__super__.constructor.apply(this, arguments);
    }

    AddStructureChangeModal.prototype.afterLoad = function() {
      return this.$form = this.$('form');
    };

    AddStructureChangeModal.prototype.submitForm = function(event) {
      if (!this.$('.js-select-audit-radio-button').is(':checked')) {
        $('.js-select-audit-error-msg').removeClass('hide');
        event.preventDefault();
        return $.ajax({
          ...
          success: (function(_this) {
            return function(data) {
              _this.model.set(data.measure_selection);
              _this.collection.add(data.structure_changes);
              _this.$el.trigger('closeModal');
              return triggerAuditReportSummary(data);
            };
          })(this)
        });
    ...
    return AddStructureChangeModal;
...
(function() {
  ...
  AuditReports.Views.AuditReportField = (function(superClass) {
    extend(AuditReportField, superClass);

    function AuditReportField() {
      return AuditReportField.__super__.constructor.apply(this, arguments);
    }

    AuditReportField.prototype.className = 'col-3';

    AuditReportField.prototype.inputClass = "js-measure-selection-field";

    AuditReportField.prototype.syncUrl = function() {
      return ("/calc/audit_reports/" + (this.model.get('audit_report').get('id')) + "/") + ("field_values/" + (this.model.get('id')));
    };

    return AuditReportField;
...
(function() {
  ...
  AuditReports.Views.AuditReportNameField = (function(superClass) {
    extend(AuditReportNameField, superClass);

    function AuditReportNameField() {
      return AuditReportNameField.__super__.constructor.apply(this, arguments);
    }

    AuditReportNameField.prototype.className = 'col-3';

    AuditReportNameField.prototype.inputClass = "js-audit-report-name-field";

    AuditReportNameField.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
        url: "/calc/audit_reports/" + (this.model.get('id')),
        data: {
          audit_report: {
            name: this.$input.val()
          }
...
(function() {
  ...
  AuditReports.Views.DescriptionField = (function(superClass) {
    extend(DescriptionField, superClass);

    function DescriptionField() {
      return DescriptionField.__super__.constructor.apply(this, arguments);
    }

    DescriptionField.prototype.className = 'col-6';

    DescriptionField.prototype.inputClass = "js-description-field";

    DescriptionField.prototype.template = _.template("<div class=\"fli js-fli\">\n  <div class=\"fli__label\">Description</div>\n  <textarea class=\"fli__input js-fli-input\"><%= value %></textarea>\n</div>");

    DescriptionField.prototype.setHtml = function() {
      return this.template({
        value: this.model.get('description')
      });
    };

    DescriptionField.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
    ...
    DescriptionField.prototype._afterSyncFieldValue = function(data) {};
...
(function() {
  ...
  AuditReports.Views.EditAuditReportPage = (function(superClass) {
    ...
    EditAuditReportPage.prototype.render = function() {
      ...
      this.fields.forEach((function(_this) {
...
(function() {
  ...
  AuditReports.Views.EffectiveStructureField = (function(superClass) {
    extend(EffectiveStructureField, superClass);

    function EffectiveStructureField() {
      return EffectiveStructureField.__super__.constructor.apply(this, arguments);
    }

    EffectiveStructureField.prototype.className = 'js-effective-structure-field';

    EffectiveStructureField.prototype.template = _.template("<div class=\"fli is-completed\">\n  <label class=\"fli__label\"><%= name %></label>\n  <input type=\"text\"\n         class=\"fli__input\"\n         value=\"<%= value %>\"\n         disabled>\n</div>");

    EffectiveStructureField.prototype.initialize = function(options) {
    ...
    EffectiveStructureField.prototype.render = function() {
      var html;
      html = this.template({
        name: this._name(),
    ...
    EffectiveStructureField.prototype._name = function() {
      return "Effective " + (this.model.get('name'));
    };

    return EffectiveStructureField;
...
(function() {
  ...
  AuditReports.Views.MeasureContent = (function(superClass) {
    extend(MeasureContent, superClass);

    function MeasureContent() {
      this.render = bind(this.render, this);
      return MeasureContent.__super__.constructor.apply(this, arguments);
    }

    MeasureContent.prototype.className = 'js-measure-content measure';

    MeasureContent.prototype.template = _.template("<div class=\"measure__actions\">\n  <span\n    class=\"measure__action\"\n    data-trigger='tooltip'\n    data-content='Add or remove this measure from calculations'>\n    <input\n      type='checkbox'\n      <%= checked %>\n      name='enable-measure'\n      class='js-enable-measure-checkbox'>\n  </span>\n  <a href='#'\n    class='measure__action js-delete-measure-link'\n    rel='nofollow'\n    data-trigger='tooltip'\n    data-content='Delete this measure'>\n    <i class=\"icon-trash\"></i>\n  <a>\n  <a href=\"#\"\n    class='measure__action js-add-structure-link'\n    data-trigger='tooltip'\n    data-content='Add a new structure to this measure'>\n    <i class=\"icon-plus\"></i>\n  </a>\n</div>");

    MeasureContent.prototype.notesTemplate = _.template("<p>Notes: <%= notes %></p>");

    MeasureContent.prototype.noStructuresTemplate = _.template("<div class=\"measure__empty\">\n  <a href='#' class='js-add-structure-link'>Add a structure</a> to get\n  started.\n</div>");

    MeasureContent.prototype.events = {
    ...
    MeasureContent.prototype.initialize = function(options) {
      if (options == null) {
        options = {};
      }
      this.listenTo(this.model, 'change:active', this.render);
      this.listenTo(this.model.get('structure_changes'), 'remove', this.render);
      return this.listenTo(this.model.get('structure_changes'), 'add', this.render);
    };

    MeasureContent.prototype.render = function() {
      var measureNotes;
      this.$el.html(this.template({
        checked: this.model.get('enabled') ? 'checked' : ''
      }));
      if (this.model.get('structure_changes').isEmpty()) {
        this.$el.append(this.noStructuresTemplate());
      } else {
        this._renderStructureChanges();
        this._renderMeasureSummary();
      }
      measureNotes = this.model.get('notes');
      if (measureNotes) {
        this.$el.append(this.notesTemplate({
          notes: measureNotes
        }));
      }
    ...
    MeasureContent.prototype.measureSelectionUrl = function() {
      var id, report_id;
    ...
    MeasureContent.prototype.onClickAddStructure = function(event) {
      var modal, url;
      event.preventDefault();
      url = "/calc/measure_selections/" + (this.model.get('id')) + "/structure_changes/new";
      modal = new AuditReports.Views.AddStructureChangeModal({
        collection: this.model.get('structure_changes'),
        model: this.model,
        url: url
      });
      return modal.render();
    ...
    MeasureContent.prototype.onClickDeleteMeasure = function(event) {
      event.preventDefault();
    ...
    MeasureContent.prototype.onChangeEnableMeasure = function(event) {
    ...
    MeasureContent.prototype._renderStructureChanges = function() {
      this.model.get('structure_changes').each((function(_this) {
        return function(structureChange, index) {
          return _this.$el.append(new AuditReports.Views.StructureChange({
            index: index,
    ...
    MeasureContent.prototype._renderMeasureSummary = function() {
      var measurePhotos, measureSummary;
      measureSummary = new AuditReports.Views.MeasureSummary({
        model: this.model.get('measure_summary')
      });
      this.$el.append(measureSummary.render());
      measurePhotos = new AuditReports.Views.MeasurePhotos({
        collection: this.model.get('photos')
      });
      return this.$el.append(measurePhotos.render());
    };
...
(function() {
  ...
  AuditReports.Views.MeasureField = (function(superClass) {
    extend(MeasureField, superClass);

    function MeasureField() {
      return MeasureField.__super__.constructor.apply(this, arguments);
    }

    MeasureField.prototype.className = 'col-3';

    MeasureField.prototype.inputClass = "js-measure-selection-field";

    MeasureField.prototype.syncUrl = function() {
      return ("/calc/measure_selections/" + (this.model.get('measure_summary').get('id')) + "/") + ("field_values/" + (this.model.get('id')));
    };
...
(function() {
  ...
  AuditReports.Views.MeasurePhoto = (function(superClass) {
    extend(MeasurePhoto, superClass);
    ...
    MeasurePhoto.prototype.className = "gallery__item";

    MeasurePhoto.prototype.template = _.template("<a class=\"gallery__modal-trigger js-gallery\"\n  href=\"<%= mediumUrl %>\"\n  data-fancybox-group=\"gallery\">\n    <img src=\"<%= thumbUrl %>\">\n</a>\n<input type=\"radio\"\n  <%= checked %>\n  name=\"select-measure-image\"\n  id=\"<%= id %>\"\n  class=\"js-select-image-radio\">");

    MeasurePhoto.prototype.events = {
      'change .js-select-image-radio': 'onChangeSelectImage'
    };

    MeasurePhoto.prototype.render = function() {
      this.$el.html(this.template({
    ...
    MeasurePhoto.prototype.measureSelectionUrl = function() {
      var id, measureSelection, reportId;
      measureSelection = this.model.get('measure_selection');
      reportId = measureSelection.get('report_id');
      id = measureSelection.get('id');
      return "/calc/audit_reports/" + reportId + "/measure_selections/" + id;
    };

    MeasurePhoto.prototype.onChangeSelectImage = function(event) {
      ...
      return $.ajax({
        ...
        success: (function(_this) {
          return function(data) {
            return _this.model.get('measure_selection').set(data.measure_selection);
          };
        })(this)
      });
    };
...
(function() {
  ...
  AuditReports.Views.MeasurePhotos = (function(superClass) {
    extend(MeasurePhotos, superClass);
    ...
    MeasurePhotos.prototype.className = "gallery";

    MeasurePhotos.prototype.initialize = function() {
      return this.initialSetSelected();
    };

    MeasurePhotos.prototype.render = function() {
      this.collection.each((function(_this) {
        return function(model) {
          return _this.$el.append(new AuditReports.Views.MeasurePhoto({
            model: model
          }).render());
        };
      })(this));
    ...
    MeasurePhotos.prototype.initialSetSelected = function() {
      var photoToSelect, selectedPhotoId;
      selectedPhotoId = this.collection.measure_selection.get('selected_photo_id');
      if (!selectedPhotoId) {
        return;
      }
...
(function() {
  ...
  AuditReports.Views.QuantityField = (function(superClass) {
    extend(QuantityField, superClass);

    function QuantityField() {
      return QuantityField.__super__.constructor.apply(this, arguments);
    }

    QuantityField.prototype.className = 'col-2 end-row';

    QuantityField.prototype.inputClass = "js-structure-quantity-field";

    QuantityField.prototype.originalTemplate = _.template("<div class=\"fli js-fli\">\n  <label class=\"fli__label\"><%= name %></label>\n  <input data-api-name='<%= apiName %>'\n         type=\"text\"\n         class=\"fli__input js-fli-input\"\n         required\n         <%= pattern %>\n         value=\"<%= value %>\">\n  <span class=\"fli__append js-fli-append\">/<%= nStructures %></span>\n</div>");

    QuantityField.prototype.initialize = function(options) {
      var ref;
      if (options == null) {
        options = {};
      }
    ...
    QuantityField.prototype.nStructures = function() {
      return this.model.get('original_value');
    };

    QuantityField.prototype.setDisabled = function() {
      if (this.nStructures() === 1) {
        return this.$fli.addClass('is-disabled');
      }
    };

    QuantityField.prototype.setHtml = function() {
      if (this.original) {
        ...
        return QuantityField.__super__.setHtml.apply(this, arguments);
      }
    };

    QuantityField.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
        url: "/calc/structures/" + (this.model.get('id')),
        data: {
...
(function() {
  ...
  AuditReports.Views.RecommendationField = (function(superClass) {
    extend(RecommendationField, superClass);

    function RecommendationField() {
      return RecommendationField.__super__.constructor.apply(this, arguments);
    }

    RecommendationField.prototype.className = 'col-6';

    RecommendationField.prototype.inputClass = "js-recommendation-field";

    RecommendationField.prototype.template = _.template("<div class=\"fli js-fli\">\n  <div class=\"fli__label\">Recommendation</div>\n  <textarea class=\"fli__input js-fli-input\"><%= value %></textarea>\n</div>");

    RecommendationField.prototype.setHtml = function() {
      return this.template({
        value: this.model.get('recommendation')
      });
    };

    RecommendationField.prototype.syncFieldValue = function() {
      return $.ajax({
        method: 'PUT',
        url: ("/calc/audit_reports/" + (this.model.get('report_id')) + "/") + ("measure_selections/" + (this.model.get('id'))),
        data: {
          measure_selection: {
            recommendation: this.$input.val()
          }
        },
        success: this._afterSyncFieldValue
      });
    ...
    RecommendationField.prototype._afterSyncFieldValue = function(data) {};
...
(function() {
  ...
  AuditReports.Views.StaticField = (function(superClass) {
    extend(StaticField, superClass);

    function StaticField() {
      return StaticField.__super__.constructor.apply(this, arguments);
    }

    StaticField.prototype.className = "col-3";

    StaticField.prototype.template = _.template("<div class=\"fli is-completed\">\n  <label class=\"fli__label\"><%= name %></label>\n  <input type=\"text\"\n         class=\"fli__input\"\n         value=\"<%= value %>\"\n         disabled>\n</div>");

    StaticField.prototype.initialize = function(options) {
      return this.name = options.name, this.value = options.value, options;
    };

    StaticField.prototype.render = function() {
      this.$el.html(this.template({
        name: this.name,
        value: this.value
      }));
...
(function() {
  window.DisplayReports = {
    ...
    Collections: {},
    generate: function(params) {
      return new DisplayReports.Generator(params);
    }
  };

}).call(this);
(function() {
  DisplayReports.Generator = (function() {
    function Generator(params) {
      var displayReport, page;
      displayReport = new DisplayReports.Models.DisplayReport(params.display_report);
...
(function() {
  ...
  DisplayReports.Collections.Photos = (function(superClass) {
    ...
    Photos.prototype.model = DisplayReports.Models.Photo;

    Photos.prototype.setSelected = function(photo) {
      photo.set('selected', true);
      return this.each(function(model) {
        if (model !== photo) {
          return model.set('selected', false);
...
(function() {
  ...
  DisplayReports.Models.DisplayReport = (function(superClass) {
    extend(DisplayReport, superClass);

    function DisplayReport() {
      return DisplayReport.__super__.constructor.apply(this, arguments);
    }

    DisplayReport.prototype.defaults = {
      markdown: ''
    };

    DisplayReport.prototype.relations = [
      {
        type: Backbone.HasMany,
        key: 'photos',
...
(function() {
  ...
  DisplayReports.Models.Photo = (function(superClass) {
  ...
  DisplayReports.Models.Photo.setup();
  ...
  DisplayReports.Views.Photo = (function(superClass) {
    ...
    Photo.prototype.render = function() {
      this.$el.html(this.template({
        checked: this.model.get('selected') ? 'checked' : '',
        id: this.model.get('id'),
        originalUrl: this.model.get('original_url'),
        thumbUrl: this.model.get('thumb_url')
      }));
      return this.$el;
    };
...
(function() {
  ...
  DisplayReports.Views.Photos = (function(superClass) {
    ...
    Photos.prototype.template = _.template("<h5>Cover photo</h5>\n<div class='gallery js-photos'>\n</div>");
